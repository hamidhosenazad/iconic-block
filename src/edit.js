		...
		<>
			...
			<div
				{...useBlockProps({
					...
					className: 'wp-block-iconic-block',
				})}
			>
				<div
					style={{
						...
						width: iconSize + 'px',
						height: iconSize + 'px',
						padding: '0.5%', // You can adjust the padding here
					}}
					className="iconic-block-container"
				>
					<IconComponent
						color={iconColor}
						className="iconic-block-icon"
					/>
				</div>
			</div>
